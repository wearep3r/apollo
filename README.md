...
Open a new terminal, `cd ${HOME}/.apollo` and run `apollo init`. You will be presented with a prompt to fill in some configuration:
...
From here, you can adjust `Spacefile.yml` to your needs. You should also setup infrastructure. You got three options to provide infrastructure for apollo:
